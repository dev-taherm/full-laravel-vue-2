...
<template>
    <AuthenticatedLayout>
        <div class="mx-[200px] mb-[200px]">
            ...
            >
                <div
                    class="flex items-center mt-4 space-x-4 rtl:space-x-reverse"
                >
                    <div
                    ...
                    >
                        <span
                            ...
                            >{{ postable.name.substring(0, 2) }}</span
                        >
                    </div>

                    <div class="flex-1 min-w-0">
                        <p
                            class="mb-5 text-md font-medium text-gray-900 truncate dark:text-white"
                        >
                            {{ postable.name }}
                        </p>
                    </div>
                    <div class="flex items-center mb-5">
                        <Link
                            :href="route('post.edit', { postId: post.id })"
                            class="dark:text-gray-300 mr-1"
                        >
                            <svg
